...
logger_attack.info( "********    Printing Analysis #4: IP-Address and Response Size received: Ward and Average Hierarchical Clustering  ********\nCheck 'test-save-ward-average.png' for more info!")



### Analysis 4 (8): ###### WARD AND AVERAGE HAC*****#########
...
plt.tight_layout()
##plt.show()
plt.savefig('test-save-ward-average.png')
