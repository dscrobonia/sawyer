...
def analyze(data):
    ...
    log.debug("***   Printing IP address (transformed) and most frequent hour usage pairs: *****")
    ...
    log.info("Printing Analysis #3: Host IP address - Most frequent hour of the day:")
